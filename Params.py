...
def ParseArgs():
	...
	parser.add_argument('--k', default='[5,10,20]', type=str, help='K of top K')
	parser.add_argument('--early_stop', type=int, default=30)
	parser.add_argument('--eps', type=float, default=0.02)
	parser.add_argument('--ssl_reg', default=1e-2, type=float, help='weight for contrative learning')
	parser.add_argument('--ssl_reg1', default=1e-3, type=float, help='weight for contrative learning')
